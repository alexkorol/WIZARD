...
Current male/female unarmed studies using this convention: `player-unarmed-v06-reference/` (female clothing, hair and stance revised from the owner's photograph). Figures, poses and final style remain under owner review. The logical dimensions are selected; runtime displayed size at the player plane and final camera calibration have not yet been verified.

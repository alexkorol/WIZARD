...
- **Last sweep:** 2026-08-24 10:17 local (scheduled sweep)
- **Last-seen program-branch SHA:** `2b61cd2`
- **Sweep result:** quiet — no state changes
  - MISROUTED scan (442fe49..2b61cd2): 1 commit (my sweep). No P0.
  - Lanes: opencode-1 dark ~14h, hermes-1 suspended, cursor-1 dark ~10h 46m. No new heartbeats.

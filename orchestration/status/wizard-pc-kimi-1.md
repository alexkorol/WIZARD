...
- **Last sweep:** 2026-08-24 01:18 local (scheduled sweep)
- **Last-seen program-branch SHA:** `6c2f9e7`
- **Sweep result:** quiet — no state changes
  - MISROUTED scan (66a5d9f..6c2f9e7): 1 commit (my sweep). No P0.
  - Lanes: opencode-1 dark ~5h, hermes-1 suspended, cursor-1 dark ~1h 47m. No new heartbeats.

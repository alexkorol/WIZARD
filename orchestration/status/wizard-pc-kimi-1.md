...
- **Last sweep:** 2026-08-24 13:17 local (scheduled sweep)
- **Last-seen program-branch SHA:** `5a0b32e`
- **Sweep result:** quiet — no state changes
  - MISROUTED scan (ffe8b52..5a0b32e): 1 commit (my sweep). No P0.
  - Lanes: opencode-1 dark ~17h, hermes-1 suspended, cursor-1 dark ~13h 46m. No new heartbeats.

...
- **Last sweep:** 2026-08-24 12:17 local (scheduled sweep)
- **Last-seen program-branch SHA:** `ffe8b52`
- **Sweep result:** quiet — no state changes
  - MISROUTED scan (dff1c6f..ffe8b52): 1 commit (my sweep). No P0.
  - Lanes: opencode-1 dark ~16h, hermes-1 suspended, cursor-1 dark ~12h 46m. No new heartbeats.

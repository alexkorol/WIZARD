...
- **Last sweep:** 2026-08-24 11:17 local (scheduled sweep)
- **Last-seen program-branch SHA:** `dff1c6f`
- **Sweep result:** quiet — no state changes
  - MISROUTED scan (2b61cd2..dff1c6f): 1 commit (my sweep). No P0.
  - Lanes: opencode-1 dark ~15h, hermes-1 suspended, cursor-1 dark ~11h 46m. No new heartbeats.

...
- **Last sweep:** 2026-08-24 15:17 local (scheduled sweep)
- **Last-seen program-branch SHA:** `3f779f5`
- **Sweep result:** quiet — no state changes
  - MISROUTED scan (7a7141a..3f779f5): 1 commit (my sweep). No P0.
  - Lanes: opencode-1 dark ~19h, hermes-1 suspended, cursor-1 dark ~15h 46m. No new heartbeats.

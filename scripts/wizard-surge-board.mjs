...
const successors = [
  ...
  ['020', 'Integrate Vesselforge inventory with the shared calibration adapter', 'WIZARD-SURGE-007, 012, and 014 accepted', 'tools/rpg_inventory/wizard-adapter.js, integration hooks, manifest plus generated registry; item rules forbidden', 'ARCHITECTURE'],

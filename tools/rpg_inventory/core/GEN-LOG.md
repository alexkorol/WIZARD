...
2026-07-07 10:45 PDT  MANUAL INTAKE ACCEPTED 4/4: gorget_copper, crest_hide, warclub_jade, wrap_hide_lamellar. All four were true-alpha downloads, passed qa_gate, matted through local art_matte, and composed into assets. Made gorget_copper, crest_hide, and warclub_jade live runtime art; kept wrap_hide_lamellar as promoted art pending a body-form/material hook. Added STYLE-EXPERIMENTS.md for crisp AAA/PBR product-render prompt testing without changing PROMPT.txt.

  ...
  const pack = {
    ...
    forms: {
      ...
      bracers:    { name: 'Bracers', kind: 'gloves', kindLabel: 'Handwear', w: 2, h: 2, icon: 'grips',
                    ...
                    materials: ['hide', 'quilted', 'copper', 'bronze', 'bronzescale', 'jade'],
      ...
      warclub:    { name: 'War Club', kind: 'weapon', kindLabel: 'Blunt club', w: 1, h: 3, icon: 'club',
                    ...
                    materials: ['bone', 'copper', 'bronze', 'jade'],
                    implicit: { label: '15% increased Physical Damage', stat: { id: 'phys_pct', v: 15 } } },
      ...
      focus:      { name: 'Rite Focus', kind: 'focus', kindLabel: 'Off-hand focus', w: 1, h: 3, icon: 'curio',
                    ...
                    materials: ['bone', 'copper', 'bronze', 'obsidian', 'jade', 'amber'],
                    implicit: { label: '+10 to Maximum Spirit', stat: { id: 'spirit', v: 10 } } },
    },
    ...
    brandMods: {
      ...
      warded:     { label: '+{v}% increased Ward', shape: 'scalar', tags: ['ward'], kinds: ['shield', 'focus', 'body', 'cloak', 'helmet', 'gloves', 'boots'],
                    weight: 12, tiers: [{ roll: [10, 18] }, { roll: [19, 28], minIlvl: 20 }, { roll: [29, 40], minIlvl: 50 }] },
      hale:       { label: '+{v} to Maximum Life', shape: 'flat', tags: ['life'], kinds: ['weapon', 'shield', 'focus', 'body', 'cloak', 'helmet', 'gloves', 'boots', 'belt', 'amulet', 'ring'],
                    weight: 12, tiers: [{ roll: [10, 20] }, { roll: [21, 35], minIlvl: 25 }, { roll: [36, 55], minIlvl: 55 }] },
      spirited:   { label: '+{v} to Maximum Spirit', shape: 'flat', tags: ['spirit'], kinds: ['helmet', 'amulet', 'ring', 'weapon', 'focus'],
                    weight: 10, tiers: [{ roll: [8, 15] }, { roll: [16, 26], minIlvl: 25 }, { roll: [27, 40], minIlvl: 55 }] },
      emberkiss:  { label: 'Adds {v} Ember Damage', shape: 'flat', tags: ['ember'], kinds: ['weapon', 'focus', 'amulet'],
                    weight: 6, tiers: [{ roll: [3, 7] }, { roll: [8, 14], minIlvl: 30 }, { roll: [15, 22], minIlvl: 60 }] },
      riverblessed: { label: '+{v}% to River Resistance', shape: 'scalar', tags: ['river', 'ward'], kinds: ['shield', 'focus', 'body', 'cloak', 'helmet', 'belt', 'amulet', 'ring'],
                    weight: 8, tiers: [{ roll: [8, 15] }, { roll: [16, 25], minIlvl: 25 }] },
      emberward:  { label: '+{v}% to Ember Resistance', shape: 'scalar', tags: ['ember', 'ward'], kinds: ['shield', 'focus', 'body', 'cloak', 'helmet', 'belt', 'amulet', 'ring'],
                    weight: 8, tiers: [{ roll: [8, 15] }, { roll: [16, 25], minIlvl: 25 }] },
      ...
      wealthy:    { label: '+{v}% Goods Found', shape: 'scalar', tags: ['fortune'], kinds: ['weapon', 'shield', 'focus', 'body', 'cloak', 'helmet', 'gloves', 'boots', 'belt', 'amulet', 'ring'],
      ...
      strongback: { label: '+{v} to All Attributes', shape: 'flat', tags: ['life', 'spirit'], kinds: ['amulet', 'ring', 'belt', 'focus'],

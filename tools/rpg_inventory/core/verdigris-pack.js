  ...
  const pack = {
    ...
    forms: {
      handaxe:    { name: 'Handaxe', kind: 'weapon', kindLabel: 'One-hand weapon', w: 1, h: 2, icon: 'axe',
                    ...
                    materials: ['flint', 'copper', 'bronze', 'obsidian', 'skymetal'],
      ...
      spear:      { name: 'Spear', kind: 'weapon', kindLabel: 'Reach weapon', w: 1, h: 4, icon: 'spear',
                    ...
                    materials: ['flint', 'bone', 'copper', 'bronze', 'obsidian', 'skymetal'],
      ...
      atlatl:     { name: 'Atlatl', kind: 'weapon', kindLabel: 'Dart-thrower', w: 1, h: 3, icon: 'atlatl',
                    weapon: { dmg: [8, 18], aps: 1.1 }, tags: ['reach', 'swift'], weights: { swift: 1.4 },
                    materials: ['bone', 'copper', 'bronze'],
                    implicit: { label: '+20% Projectile Range', stat: null } },
      khopesh:    { name: 'Khopesh', kind: 'weapon', kindLabel: 'Sickle-sword', w: 1, h: 3, icon: 'khopesh',
                    ...
                    materials: ['copper', 'bronze', 'skymetal'],
                    implicit: { label: '+10% Attack Speed', stat: { id: 'atk_speed', v: 10 } } },
      sling:      { name: 'Sling', kind: 'weapon', kindLabel: 'Sling', w: 1, h: 2, icon: 'sling',
                    weapon: { dmg: [5, 16], aps: 1.15 }, tags: ['reach', 'swift'], weights: { swift: 1.3 },
                    materials: ['hide', 'quilted'],
                    implicit: { label: 'Ignores half of Ward', stat: null } },
      ...
      crest:      { name: 'Crest', kind: 'helmet', kindLabel: 'Headpiece', w: 2, h: 2, icon: 'crest',
                    ...
                    materials: ['bone', 'hide', 'copper', 'bronze', 'jade'],
                    implicit: { label: '+10 to Maximum Spirit', stat: { id: 'spirit', v: 10 } } },
      grips:      { name: 'Grips', kind: 'gloves', kindLabel: 'Handwraps', w: 2, h: 2, icon: 'grips',
                    armor: 18, tags: ['blade', 'swift'], weights: {},
                    materials: ['hide', 'quilted', 'bronzescale'],
                    implicit: { label: '+8% Attack Speed', stat: { id: 'atk_speed', v: 8 } } },
      ...
      gorget:     { name: 'Gorget', kind: 'amulet', kindLabel: 'Neckpiece', w: 1, h: 1, icon: 'gorget',
                    ...
                    materials: ['jade', 'amber', 'bone', 'copper'],
      ...
      ring:       { name: 'Ring', kind: 'ring', kindLabel: 'Ring', w: 1, h: 1, icon: 'ring',
                    ...
                    materials: ['bone', 'copper', 'jade', 'amber'],
                    implicit: { label: '+12 to Maximum Life', stat: { id: 'life', v: 12 } } },
      curio:      { name: 'Curio', kind: 'curio', kindLabel: 'Curio', w: 1, h: 1, icon: 'curio',
                    armor: 0, tags: [], noVessel: true, materials: ['bone', 'jade', 'amber'], implicit: null },
      ...
      greataxe:   { name: 'Greataxe', kind: 'weapon', kindLabel: 'Two-hand axe', w: 2, h: 3, icon: 'axe',
                    ...
                    materials: ['copper', 'bronze', 'obsidian', 'skymetal'],
      ...
      helm:       { name: 'Helm', kind: 'helmet', kindLabel: 'War helm', w: 2, h: 2, icon: 'crest',
                    ...
                    materials: ['copper', 'bronze', 'bronzescale', 'rivetmail'],
    ...
    brandMods: {
      ...
      swift_haft: { label: '+{v}% Attack Speed', shape: 'scalar', tags: ['swift'], kinds: ['weapon'],
      ...
      warded:     { label: '+{v}% increased Ward', shape: 'scalar', tags: ['ward'], kinds: ['shield', 'body', 'helmet', 'gloves', 'boots'],
                    weight: 12, tiers: [{ roll: [10, 18] }, { roll: [19, 28], minIlvl: 20 }, { roll: [29, 40], minIlvl: 50 }] },
      hale:       { label: '+{v} to Maximum Life', shape: 'flat', tags: ['life'], kinds: ['weapon', 'shield', 'body', 'helmet', 'gloves', 'boots', 'belt', 'amulet', 'ring'],
                    weight: 12, tiers: [{ roll: [10, 20] }, { roll: [21, 35], minIlvl: 25 }, { roll: [36, 55], minIlvl: 55 }] },
      spirited:   { label: '+{v} to Maximum Spirit', shape: 'flat', tags: ['spirit'], kinds: ['helmet', 'amulet', 'ring', 'weapon'],
                    weight: 10, tiers: [{ roll: [8, 15] }, { roll: [16, 26], minIlvl: 25 }, { roll: [27, 40], minIlvl: 55 }] },
      emberkiss:  { label: 'Adds {v} Ember Damage', shape: 'flat', tags: ['ember'], kinds: ['weapon', 'amulet'],
                    weight: 6, tiers: [{ roll: [3, 7] }, { roll: [8, 14], minIlvl: 30 }, { roll: [15, 22], minIlvl: 60 }] },
      riverblessed: { label: '+{v}% to River Resistance', shape: 'scalar', tags: ['river', 'ward'], kinds: ['shield', 'body', 'helmet', 'belt', 'amulet', 'ring'],
                    weight: 8, tiers: [{ roll: [8, 15] }, { roll: [16, 25], minIlvl: 25 }] },
      emberward:  { label: '+{v}% to Ember Resistance', shape: 'scalar', tags: ['ember', 'ward'], kinds: ['shield', 'body', 'helmet', 'belt', 'amulet', 'ring'],
                    weight: 8, tiers: [{ roll: [8, 15] }, { roll: [16, 25], minIlvl: 25 }] },
      surefoot:   { label: '+{v}% Movement Speed', shape: 'scalar', tags: ['swift'], kinds: ['boots'],
                    weight: 9, tiers: [{ roll: [5, 9] }, { roll: [10, 15], minIlvl: 30 }] },
      keen_eye:   { label: '+{v}% Critical Chance', shape: 'scalar', tags: ['blade', 'swift'], kinds: ['weapon', 'ring'],
                    weight: 7, tiers: [{ roll: [8, 14] }, { roll: [15, 22], minIlvl: 35 }] },
      wealthy:    { label: '+{v}% Goods Found', shape: 'scalar', tags: ['fortune'], kinds: ['weapon', 'shield', 'body', 'helmet', 'gloves', 'boots', 'belt', 'amulet', 'ring'],
      ...
      strongback: { label: '+{v} to All Attributes', shape: 'flat', tags: ['life', 'spirit'], kinds: ['amulet', 'ring', 'belt'],
